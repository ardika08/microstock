...
// ── Inline button injection (SATU-SATUNYA trigger Run Batch utk Vecteezy) ──
// Aksi di halaman, setting di popup (toggle AI-generated + Stop).
// Popup TIDAK punya tombol Run Batch untuk Vecteezy — hindari dobel trigger.
